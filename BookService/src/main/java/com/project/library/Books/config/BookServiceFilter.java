package com.project.library.Books.config;
...
@Component
public class BookServiceFilter extends OncePerRequestFilter {
    ...
    private String getSharedSecretFromDB() {
        ...
        return jdbcTemplate.queryForObject(sql, new Object[]{"bookservice"}, String.class);
    }
    ...
    protected void doFilterInternal(
        ...
        var creds = jdbcTemplate.queryForMap(sql, "bookservice");
